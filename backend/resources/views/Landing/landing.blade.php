...
<body>
            ...
            <a href="#" class="row align-items-center hero-post">
                <div class="col-md-6">
                    <img src="{{ asset('storage/images/' . $programNew->gambar) }}" alt="gmbar"
                        class="rounded-3 mb-3 hero-post-img img-fluid">
                </div>
                <div class="col-md-6">
                    <span class="bg-light rounded p-2 fw-bold text-primary category">Program Terbaru</span>
                    <h2 class="hero-post-title text-primary text-capitalize mt-3">{{ $programNew->nama_program }}</h2>
    ...
    <section id="sejak_dini" class="py-5">
        <div class="container">
            <div class="box text-center justify-content-center align-items-center">
    ...
    <section>
        <div class="container mt-5 ">
            <div class="box text-center justify-content-center align-items-center py-5">
